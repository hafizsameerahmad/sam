<%@ page title="" language="VB" masterpagefile="~/MasterPage.master" autoeventwireup="false" inherits="cat_banner, App_Web_d5yn2pzd" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
                    ...
                    <div class="col-lg-12" >
                        <div class="card">
                            <div class="card-header">
                                <strong>Category Banner</strong> info
                            </div>
                            <div class="card-body card-block">
                                <div  class="form-horizontal">
                                    ...
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="select" class=" form-control-label">Position</label></div>
                                        <div class="col-12 col-md-6">
                                            <select name="select" id="ddposition" runat ="server" class="form-control">
    ...
    <asp:DropDownList ID="ddhome" runat="server" CssClass="form-control" AppendDataBoundItems="True" >
                                    ...
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="text-input" class=" form-control-label">Name (Optional)</label></div>
                                        <div class="col-12 col-md-6"><input type="text" id="txtname" runat="server" name="text-input" placeholder="Please enter name (Optional)" class="form-control" maxlength="50" /><%--<small class="form-text text-muted">Name in English</small>--%></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="email-input" class=" form-control-label">Description (Optional)</label></div>
    ...
    <ItemTemplate>   
                                        <tr>
                                          ...
                                          <td><asp:Label ID="Label3" runat="server" Text='<%# Eval("TB_POSITION") %>'  /></td>
                                               <td> <asp:Image ID="Image1" runat="server" Height="70px" 
                                              ImageUrl='<%# Bind("TB_IMG", "~/Images/{0}") %>'  onclick="CreatepopUp(this.src);" /><br />
                                                   <%# Eval("TB_EXP_DATE") %>
                                               </td>
