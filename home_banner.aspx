<%@ page title="" language="VB" masterpagefile="~/MasterPage.master" autoeventwireup="false" inherits="home_banner, App_Web_d5yn2pzd" %>
                    ...
                    <div class="col-lg-12" >
                        <div class="card">
                            <div class="card-header">
                                <strong>Home Banner</strong> info
                            </div>
    ...
    <ItemTemplate>   
                                        <tr>
                                          ...
                                          <td><asp:Label ID="Label3" runat="server" Text='<%# Eval("TB_POSITION") %>'  /></td>
                                              ...
                                              ImageUrl='<%# Bind("TB_IMG", "~/Images/{0}") %>'  onclick="CreatepopUp(this.src);" />
                                                   <br />
                                                   <%# Eval("TB_EXP_DATE") %>
                                               </td>
