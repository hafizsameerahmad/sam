<%@ page title="" language="VB" masterpagefile="~/MasterPage.master" autoeventwireup="false" inherits="lov_type, App_Web_cuqsth1s" %>
    ...
    <ItemTemplate>   
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <asp:LinkButton ID="LinkButton2" runat="server" CommandName="DEL" CssClass="btn btn-danger btn-sm" Visible="False">Delete</asp:LinkButton>
                                                 <asp:LinkButton ID="LinkButton3" runat="server" CommandName="CAT" CssClass="btn btn-secondary btn-sm">Category</asp:LinkButton>
                                            </td>
