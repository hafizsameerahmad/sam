<%@ page title="" language="VB" masterpagefile="~/MasterPage.master" autoeventwireup="false" inherits="users, App_Web_d5yn2pzd" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
                            ...
                            <div class="card-body card-block">
                                <div  class="form-horizontal">
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-6">
                                            <select name="select" id="ddgender" runat ="server" class="form-control">
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-6"><input type="text" id="txtname" runat="server" name="text-input" placeholder="Please enter full name" class="form-control" maxlength="50" /><%--<small class="form-text text-muted">Name in English</small>--%></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="email-input" class=" form-control-label">Email</label></div>
                                        <div class="col-12 col-md-6"><input type="text" id="txtemail" runat="server" name="text-input" placeholder="Email" class="form-control" maxlength="50" /><%--<small class="help-block form-text">Name in Arabic</small>--%></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="email-input" class=" form-control-label">Mobile</label></div>
                                        <div class="col-12 col-md-6"><input type="text" id="txtmobile" runat="server" name="text-input" placeholder="Mobile (Optional)" class="form-control" maxlength="50" /><%--<small class="help-block form-text">Name in Arabic</small>--%></div>
                                    </div>
                                   <div class="row form-group">
                                        <div class="col col-md-3"><label for="email-input" class=" form-control-label">Password</label></div>
                                        <div class="col-12 col-md-6"><input type="password" id="txtpass" runat="server" name="text-input" placeholder="Password" class="form-control" maxlength="50" /><%--<small class="help-block form-text">Name in Arabic</small>--%></div>
                                    </div>
    ...
    <ItemTemplate>   
                                        <tr>
                                            ...
                                            <td><%# Eval("TB_FNAME") %></td>
                                           <td><asp:Label ID="Label3" runat="server" Text='<%# Eval("TB_EMAIL") %>'  /><br />
                                               <%# Eval("TB_MOBILE") %></td>
