<%@ page title="" language="VB" masterpagefile="~/MasterPage.master" autoeventwireup="false" inherits="comp_gallery, App_Web_d5yn2pzd" %>
                            ...
                            <div class="card-body card-block">
                                <div  class="form-horizontal">
                                      <div class="row form-group">
                                       ...
                                       <div class="row form-group">
                                        <div class="col col-md-3"><label for="select" class=" form-control-label">Default</label></div>
                                        <div class="col-12 col-md-6">
                                            <select name="select" id="dddefault" runat ="server" class="form-control">
    ...
    <ItemTemplate>   
                                        <tr>
                                            <td><asp:Label ID="Label1" runat="server" Text='<%# Eval("TB_ID") %>'  /></td>
                                             <td><asp:Label ID="Label3" runat="server" Text='<%# Eval("TB_ORDER") %>'  /></td>
                                              <td><asp:Label ID="Label2" runat="server" Text='<%# Eval("TB_DEFAULT") %>'  /></td>
